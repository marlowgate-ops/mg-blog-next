...
type Props = { label: string; children: React.ReactNode; side?: "top" | "right" | "bottom" | "left"; };
  ...
  return (
    <span className="mg-tooltip-wrapper" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
      ...
      <style jsx global>{`
        ...
        .mg-tooltip { position: absolute; background: rgba(0,0,0,.8); color:#fff; font-size:12px; line-height:1.4; padding:6px 8px; border-radius:4px; white-space:nowrap; transition: opacity .15s ease; z-index:30; }
