...
export default function Page() {{
  ...
  const il = itemListJSONLD("口座開設キャンペーン一覧", [{ name:'DMM.com証券', url:'/best/forex-brokers-jp#rank-1' },{ name:'松井証券（準備中）', url:'/best/forex-brokers-jp#rank-2' },{ name:'ゴールデンウェイ・ジャパン（FXTF）', url:'/best/forex-brokers-jp#rank-3' }]);
  return (
    <main style={{{padding:'16px'}}}>
      ...
      <section aria-labelledby="rank"><h2 id="rank" style={{fontSize:18,margin:'12px 0'}}>口座開設キャンペーン一覧</h2><p style={{color:'#334155'}}>最大額・締切・条件で一覧比較。<strong>進呈条件の達成難易度</strong>も合わせて確認しましょう。</p><div style={{marginTop:10}}><span style={{fontSize:12,color:'#64748b'}}>※ 公式条件は各社サイトを必ずご確認ください。</span></div></section>
