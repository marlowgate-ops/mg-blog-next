...
export default function Page() {
  ...
  const rows = brokers.map(b => ({
    brand: b.name, product: b.product, platform: b.platform, cost: b.costNote,
    minUnit: b.minUnit, accountFee: b.accountFee, depositWithdraw: b.depositWithdraw,
    api: b.api, tools: b.tools, appScore: b.appScoreText, support: b.support, note: b.note,
    state: b.state, ctaHref: b.site,
  }));
