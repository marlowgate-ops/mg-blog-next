...
export default function Page() {
  return (
    <main>
      <p>※本ページには広告が含まれます。<a href="/disclaimer">免責</a></p>
      <h1>【2025年版】国内向けおすすめFX・CFD業者ランキング</h1>
      <p>結論：初心〜中級でまず実務が安定する、<strong>国内サービス</strong>を中心に選ぶ。評価軸は「スプレッド/手数料・約定・入出金・サポート」。</p>
      <BestDomestic />
      <p>表示の順序やスコアは編集部判断です。料金や条件は変動します。最新は各公式をご確認ください。</p>
    </main>
  )
}
